...
public class BGCPlayer extends Player implements IWorldObject{
    // Player health.
    ...
    public BGCPlayer(String name, GridCell startCell, Skin skin, KeyBinding keyBinding,
                     ...
                     IWorld world, IStateMachine stateMachine) {
    ...
    public void Render(GameEngine engine) {
        ...
        engine.drawImage(_image.Image,
                _image.Reflect? (_body.get(0).Column * _skin.CellWidth + GameImage.NPC_WIDTH) : (_body.get(0).Column * _skin.CellWidth + 5),
                _body.get(0).Row * _skin.CellHeight + 5,
                (_image.Reflect? -1 : 1) * (GameImage.NPC_WIDTH + 5),
                GameImage.NPC_HEIGHT + 10);
    }
